...
@export var id: String = ""        # heal|maxhp|symbol|shield|power|gold|consumable|weapon|maxhp_heal|elite_*（对应 apply_reward 分支）
...
@export var rarity: String = "common"   # common|uncommon|rare——抽取权重档（胜利奖励方案 2026-08-13：50/30/20）
