...
@export var effect: String = ""          # 主动: purify/heal/assault/reroll/element；被动: damage_bonus/room_shield/shield/interference_resist/damage_mult/armor_pierce/element_boost/status_boost（T2 三项缺口）
