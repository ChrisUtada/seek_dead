...
```
# Seek Dead · ACT1 试玩
版本：demo-act1-v1.0 ｜ 时长：≥60 分钟（3 轮）
...
| 风险 | 应对 |
|---|---|
| 1 小时不够/太长 | 单轮时长由房间节奏决定：若单轮 >30 分钟，调 `ante_room_step_hp` 或减课程化房数；若 <15 分钟，加 BOSS 轮替体验（多打几轮） |
