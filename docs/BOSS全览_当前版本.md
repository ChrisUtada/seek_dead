...
|---|---|---|---|---|
| 深渊监视者 | 注废（池×比例，残血加快），attack 60/heavy 40 | 闪回暴走：50% 强制重转 + 注废×1.5 + 甲 40 + attack 40/heavy 30/jam 30 | 深渊吞噬：注废×2 + 攻 ×1.3 + 甲 45 + attack 50/heavy 50 | 6 件：深渊巨镰 / 深渊壁垒（盾 12）/ 梦魇屏障（盾+12）/ 噩梦凝视（攻+8）/ 重铸风暴（reroll×3）/ 暗影再生（回 6） |
