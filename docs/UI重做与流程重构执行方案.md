...
### 1.3 不变部分
- **覆盖层**：整备/元进度/铁砧 仍全屏（决策态，与实时动作布局不冲突）；**奖励已改为居中卡片弹层、商店已改为右侧抽屉（D2）**，二者不再铺满全屏。P3b-2 抽独立 `.tscn` 正是为此铺垫，**本次布局重排零波及**。
