...
echo [1/6] L0 intent act-gating regression ...
...
echo [2/6] L0 boss loot theme regression ...
...
echo [3/6] L1 content and math lint ...
...
echo [4/6] L2+L3 full-run smoke and boss phase probes, about 40s ...
...
echo [5/6] T8 drop channels regression, about 60s ...
...
echo [6/6] T7 acquisition weighting regression, about 60s ...
